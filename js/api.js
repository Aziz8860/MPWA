const API_KEY = "41b5a5129e4441ea8142067b5561acb3";
  ...
  data.teams.forEach(function (tim) {
      ...
      <div class="card">
        ...
        <div class="card-action right-align">
            <a class="waves-effect waves-light btn-small teal lighten-1" onclick="insertTeamListener(${tim.id})">♡ Favorite</a>
        </div>
      </div>
    </div>
      `;
...
// database operations
var dbx = idb.open('favorite', 1, upgradeDb => {
